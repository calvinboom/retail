    ...
    return (
        <>
            <Card style={{ borderRadius: "10px" }}>
                <CardHeader title="สินค้าใกล้หมดอายุ" sx={{ "& .MuiCardHeader-action": { alignSelf: "center" } }} />
                <Divider />
                        ...
                        <List sx={{ width: "100%", bgcolor: "background.paper" }}>
                            {payments.map((item, index) => (
                                <ListItem key={item?._id} disableGutters divider={!isLastItem(index)} sx={{ px: "16px", py: "0" }}>
                                    <ListItemAvatar sx={{ width: "63px", paddingRight: "15px", color: "red" }}>{"อันดับ " + (Number(index) + 1)}</ListItemAvatar>
                                    <ListItemText
                                        primary={
                                            <React.Fragment>
                                        ...
                                        secondary={
                                            <React.Fragment>
                                                ...
                                                >
                                                    วันหมดอายุ: {dayjs(item?.expiry_date).format("MMM D, YYYY HH:mm")}
                                                </Typography>
                                            </React.Fragment>
                                        }
                                    />
                                        ...
                                        secondary={
                                            <React.Fragment>
                                                <Typography component="span" variant="caption">
                                                    {parseFloat(item?.buy_price).toLocaleString("th-TH", { style: "currency", currency: "THB" }) + "/หน่วย"}
                                                </Typography>
                                            </React.Fragment>
                                        }
                                    />
